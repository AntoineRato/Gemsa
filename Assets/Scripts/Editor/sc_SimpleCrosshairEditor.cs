...
[CustomEditor(typeof(sc_SimpleCrosshair))]
public class sc_SimpleCrosshairEditor : Editor
{
    private sc_SimpleCrosshair simpleCrosshair;
    ...
    {
        simpleCrosshair = (sc_SimpleCrosshair)target;
